...
| `Rocks_Portal_Form_UAT` | The UAT twin, served to configured testers, plus `UatTesterPerDiem` — a per-tester per-diem override read only in UAT (migrations 139/140, moved from `Fast_Core`, no synonym) |
