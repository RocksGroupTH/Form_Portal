...
| `Rocks_Portal_Form_UAT` | The UAT twin, served to configured testers, plus the tester roster itself — `UatTester` (migrations 139/140, moved from `Fast_Core`, which keeps a permanent synonym for ACC Portal) |
| `Fast_Core` | Shared config, brand/connection settings, plus this app's `FormEnvironment` |
