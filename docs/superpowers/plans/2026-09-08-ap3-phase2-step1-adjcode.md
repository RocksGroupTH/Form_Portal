...
- [ ] **Step 3: Add `adjCode` to the wire shape**
...
- [ ] **Step 4: Add the date to the item and set the marker**
...
- [ ] **Step 1: Carry the field through**
...
- [ ] **Step 2: Verify the chain against real data**
...
- [ ] **Step 1: Carry the marker on the preview line**
...
- [ ] **Step 2: Render it beside the branch**
...
- [ ] **Step 1: Create the marked clearing on UAT**
...
- [ ] **Step 2: Approve it through all three steps**
...
- [ ] **Step 5: Send a control case**

Repeat with a receipt dated in the **current** month and confirm the preview
shows no badge and the send still succeeds. This is what proves the rule
