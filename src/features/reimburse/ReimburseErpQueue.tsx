            ...
            <p className="text-[13px]" style={{ color: "var(--text-muted)" }}>
              ...
              */}
              {rows.length > 0
                ...
                : scope === null
                  ? "คุณยังไม่ได้เป็นผู้อนุมัติฝ่ายบัญชีของ AP-4 จึงไม่แสดงรายการให้ — ผู้ดูแลระบบเปิดใช้งานคุณและติ๊กแบรนด์ที่คุณอนุมัติได้ (อย่างน้อย 1 แบรนด์) ได้ที่ ตั้งค่าขอเบิกเงินคืนพนักงาน → สิทธิ์เข้าถึง"
                  : scope.length === 0
