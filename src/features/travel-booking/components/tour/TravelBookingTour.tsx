...
const STEPS: GuidedTourStep[] = [
  ...
  },
  {
    ...
    body: "เลือกเหตุผล อธิบายงานที่ไปทำ และใส่สถานที่ปฏิบัติงานอย่างน้อย 1 แห่ง — เมื่อเลือกสถานที่จากแผนที่ ระบบจะเดาจังหวัดให้ แต่ต้องตรวจว่าถูกต้องเพราะจังหวัดคือตัวกำหนดอัตราเบี้ยเลี้ยง",
  },
  {
