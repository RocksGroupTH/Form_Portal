...
const STEPS: GuidedTourStep[] = [
  ...
  },
  {
    ...
    body: "ต้องแนบรูปบัตรประชาชน หรือ Passport เพื่อใช้จองที่พัก/ตั๋ว รับเฉพาะไฟล์รูปและระบบจะตรวจก่อนว่าเป็นบัตรจริง — ถ้าเลือกให้เก็บไว้ ครั้งต่อไปกดใช้รูปเดิมซ้ำได้ทันที",
  },
  {
