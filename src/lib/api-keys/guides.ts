...
export const KEY_GUIDES: Record<string, KeyGuide> = {
  ANTHROPIC_API_KEY: {
    ...
    notes: [
      ...
      "ถ้า key หมดอายุหรือถูกเพิกถอน **คำขอ AP-17 ที่ต้องยืนยันตัวตนจะแนบเอกสารไม่ได้และส่งไม่ได้** เพราะด่านตรวจเอกสารตั้งไว้ให้ปิดตาย — ตั้งแต่ 22/09/2026 จะกระทบเฉพาะทริปที่ที่พัก/พาหนะ/รถเช่าที่เลือกไว้ถูกตั้งค่าว่าต้องแนบ (เดิมกระทบทั้งบริษัท) ส่วน AP-1 แค่กรอกยอดเอง",
    ],
  },
