...
export const RECEIPT_SYSTEM = [
  ...
  "  payeeName from.",
  "  Read it one digit at a time, in the five groups a Thai tax id is printed in:",
  "  1-4-5-2-1, like 0-1055-64122-64-9. Invoices print the dashes as often as not;",
  "  copy them when they are there. The grouping is what keeps the digits in their",
  "  places — the mistake this field actually suffers is two adjacent digits swapped",
  "  in a long unbroken string, which changes the company and nothing else on the",
  "  page disagrees.",
