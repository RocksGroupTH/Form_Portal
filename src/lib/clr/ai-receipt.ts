...
const SYSTEM = [
  ...
  "- description: if the receipt lists several line items, use the description of the",
  ...
  "- amountBeforeVat, vat, wht: numbers in THB (no commas). If the receipt lists several",
  "  line items, amountBeforeVat and vat must reflect the TOTAL of the WHOLE receipt (the",
  "  grand total across all lines) — NOT just the amount of the largest line item chosen",
